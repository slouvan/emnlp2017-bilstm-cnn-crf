...
wait
python Train_MTL_Sequence_Tagging.py -i input/MIT_Restaurant_OntoNotes_NW -d MTL_MIT_Restaurant_OntoNotes_NW_BestDropout_12_July -p params/MTL_MIT_Restaurant_OntoNotes_NW
