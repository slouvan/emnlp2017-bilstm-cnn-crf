#!/bin/sh
# Train CoNLL first
python Train_STL_Sequence_Tagging.py -i input/CoNLL_2003 -p params/STL_Default_Param -ro results_emnlp -d STL_CoNLL_2003 -e 1 
wait 
...
python Train_STL_Sequence_Tagging.py -i input/ATIS_CoNLL_Feature -ro results_emnlp -d STL_ATIS_CoNLL_Feature -p params/STL_NER_Feature_Param -e 1
wait
...
python Train_STL_Sequence_Tagging.py -i input/MIT_Restaurant_CoNLL_Feature -ro results_emnlp -d STL_MIT_Restaurant_CoNLL_Feature -p params/STL_NER_Feature_Param -e 1
wait
...
wait
python Train_STL_Sequence_Tagging.py -i input/MIT_Movie_CoNLL_Feature -ro results_emnlp -d STL_MIT_Movie_CoNLL_Feature -p params/STL_NER_Feature_Param -e 1